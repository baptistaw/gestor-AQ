...
import { ArrowLeftIcon, KeyIcon, BriefcaseIcon } from './icons.tsx';

interface SurgeonLoginProps {
  onLogin: (professionalLicenseNumber: string, password: string) => void;
  onBack: () => void;
  loginError: string;
}

const SurgeonLogin: React.FC<SurgeonLoginProps> = ({ onLogin, onBack, loginError }) => {
    ...
    <div className="flex flex-col items-center justify-center min-h-screen -my-8">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg">
            <h1 className="text-2xl font-bold text-center text-slate-800">Portal de Cirugía</h1>
