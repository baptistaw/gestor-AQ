...
import { DocumentTextIcon, PencilSquareIcon, ArrowLeftOnRectangleIcon, ChatBubbleLeftRightIcon, ArrowDownTrayIcon, ClipboardDocumentListIcon, BriefcaseIcon, CalendarDaysIcon, BellAlertIcon, UserIcon, CakeIcon, UsersIcon, CheckCircleIcon } from './icons.js';
