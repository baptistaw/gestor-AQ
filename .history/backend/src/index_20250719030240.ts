...
app.post('/api/surgeons/login', async (req: express.Request, res: express.Response) => {
...
app.post('/api/anesthesiologists/login', async (req: express.Request, res: express.Response) => {
    const { professionalLicenseNumber, password } = req.body;
    try {
        // In a real production app, passwords must be hashed and compared securely.
