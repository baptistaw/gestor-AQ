...
const transpileMiddleware = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
...
const processPatient = (patient: Prisma.Patient & { surgicalConsent: any, anesthesiaConsent: any } | null) => {
...
app.get('/api/consent-forms/:id/pdf', async (req: express.Request, res: express.Response) => {
    const { id } = req.params;
    try {
