...
// Servir los archivos estáticos del frontend (JS, CSS, etc.)
// Se añade una configuración de headers para que los archivos .ts y .tsx
// se sirvan con el tipo MIME de JavaScript. Esto evita el error de MIME estricto
// del navegador y permite que herramientas como Babel Standalone los procesen.
...
// Ruta catch-all para servir index.html para el enrutamiento del lado del cliente de la SPA.
