...
// Esta es la forma más robusta y estándar. Configuramos `express.static`
// para que establezca un Content-Type personalizado para los archivos .ts y .tsx.
// Esto es crucial para que el transformador de Babel en el navegador funcione correctamente.
