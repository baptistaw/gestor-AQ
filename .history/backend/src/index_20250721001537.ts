...
app.post('/api/ai/generate-medication-instructions', async (req, res) => {
 ...
 //──────────────────────────────────────────────────────────────
//  Fasting Plan (1‑a‑1 con Patient)
//──────────────────────────────────────────────────────────────

// GET  /api/patients/:id/fasting-plan
...
// PUT  /api/patients/:id/fasting-plan
app.put('/api/patients/:id/fasting-plan', async (req, res) => {
  ...
  try {
    ...
    // 🚀  Programa notificación de inicio de ayuno
...
//──────────────────────────────────────────────────────────────
//  Suspensiones (1‑a‑N con Patient)
//──────────────────────────────────────────────────────────────

// GET  /api/patients/:id/suspensions
...
// POST /api/patients/:id/suspensions
...
// DELETE /api/patients/:id/suspensions/:suspId
