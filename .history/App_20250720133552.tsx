// src/App.tsx  (solo las DOS primeras líneas cambian)
import * as React from 'react';                 // 👈 1) importa React entero
const { useState, useCallback, useEffect } = React;  // 👈 2) desestructura hooks

//------------------------------------------------------------
//  Todo lo demás permanece igual
//------------------------------------------------------------
import { View, Patient, Surgeon, Anesthesiologist } from './types.ts';
