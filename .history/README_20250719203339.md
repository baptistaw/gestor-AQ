...
Si quieres hacer cambios en el futuro, puedes ejecutar toda la aplicación localmente. **Todos los comandos se deben ejecutar desde la carpeta raíz del proyecto.**
...
2.  **(Opcional) Poblar la base de datos con datos de prueba:**
    - Para tener usuarios de ejemplo (cirujano y anestesiólogo), ejecuta:
      ```bash
      npm run db:seed
      ```
