...
import AnesthesiologistDashboard from './backend/src/components/AnesthesiologistDashboard.tsx';
import PatientLogin from './backend/src/components/PatientLogin.tsx';
import PatientConsentView from './backend/src/components/PatientConsentView.tsx';
import LandingPage from './backend/src/components/LandingPage.tsx';
import SurgeonDashboard from './backend/src/components/SurgeonDashboard.tsx';
import SurgeonLogin from './backend/src/components/SurgeonLogin.tsx';
import AnesthesiologistLogin from './backend/src/components/AnesthesiologistLogin.tsx';
/* ▼ NUEVOS imports Admin ▼ */
import { Admin }              from './types.ts';
import AdminLogin             from './backend/src/components/AdminLogin.js';
import AdminDashboard         from './backend/src/components/AdminDashboard.tsx';
/* ▲ NUEVOS imports Admin ▲ */
