...
1.  **Configurar el Backend y la Base de Datos:**
    ...
    - Prepara la base de datos local aplicando las migraciones: `npx prisma migrate deploy`. (Usa `migrate dev` si es la primera vez o si cambias el schema).
    - **Crea usuarios de prueba** para poder iniciar sesión: `npm run db:seed`.
