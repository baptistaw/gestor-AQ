...
import { UserPlusIcon, ArrowRightOnRectangleIcon, CheckCircleIcon, ClockIcon, BriefcaseIcon, QrCodeIcon, BellAlertIcon, EnvelopeIcon } from './icons.tsx';
        ...
        <Modal onClose={() => setShowQrModalFor(null)}>
            <div className="bg-white p-8 rounded-xl shadow-2xl text-center max-w-sm mx-auto">
                ...
                <div className="p-4 bg-white inline-block rounded-lg border">
                    <QRCodeSVG value={patientPortalUrl} size={256} fgColor="#1e293b" />
                </div>
