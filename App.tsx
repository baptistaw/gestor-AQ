...
import { View, Patient, Surgeon, Anesthesiologist } from './types';
import AnesthesiologistDashboard from './components/AnesthesiologistDashboard';
import PatientLogin from './components/PatientLogin';
import PatientConsentView from './components/PatientConsentView';
import LandingPage from './components/LandingPage';
import SurgeonDashboard from './components/SurgeonDashboard';
import SurgeonLogin from './components/SurgeonLogin';
import AnesthesiologistLogin from './components/AnesthesiologistLogin';
